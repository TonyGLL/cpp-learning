...
void saveResults(const std::vector<Subject> &list)
{
    ...
    outputFile << "================================" << std::endl;
    outputFile << "SUBJECTS CALIFICATIONS" << std::endl;
    outputFile << "================================" << std::endl;
    ...
    for (int i = 0; i < list.size(); i++)
    {
        ...
        outputFile << "Subject: " << name << "          | Score: " << score << std::endl;
        result += score;
    }

    double avg = result / list.size();
    outputFile << "--------------------------------" << std::endl;
    outputFile << "FINAL AVERAGE: " << result / list.size() << std::endl;

    std::string status = "REPROVED";
    if (avg >= 6)
    {
        status = "APPROVED";
    }
    ...
    std::cout << "File score.txt created successfully" << std::endl;
}